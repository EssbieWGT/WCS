...
#py ./scripts/tricare.py

script_to_run = "./templates/single.py"  # Replace with the actual path
filepath = "./masterdata/tricare.csv"
tsPath = "./timestamps/tricareTS.json"
rss_url = "https://www.google.com/alerts/feeds/07456959579114045064/2802828745890061489" #TRICARE
savepath = "./data/tricare.csv"
...
if return_code == 0:
    ...
    # ssh-add C:\Users\wesle/.ssh/id_ed25519